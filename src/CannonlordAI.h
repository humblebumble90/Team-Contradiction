...
private:
	...
	int positiveRotation = 0, rotation = 0, rotationTimer = 0, rotationTimerReset = 30, rotationFactor = 3, rotationIteration = 0, movementTimer = Config::SCREEN_WIDTH / 20, movementTimerReset = Config::SCREEN_WIDTH / 20, attackCooldown = 25, attackCooldownReset = 25;
